...
\begin{document}
    ...
    %TODO Bild einfpgen%
   	...
   	Das Problem kann mit einem $Step-Up Boost-Converter$ erfolgreich gelöst werden. Hier wurde das in Abbildung xy dargestellte Modul verwendet.   	%TODO Abbildung%
