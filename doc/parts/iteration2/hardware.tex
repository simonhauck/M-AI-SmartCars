...
\begin{document}
    ...
    Weitere Nachforschungen bezüglich der Fahrzeugschaltung haben ergeben, dass der $Output$ Pin des Hall Sensor mit einem $1k\ \Omega$  Widerstand an den $3.3V$ sowie den gewählten IO-Pin angeschlossen werden muss. Das neue Diagramm ist in \autoref{fig-hardware-car-iteration2} dargestellt.
       	\begin{figure}[H]
    	\begin{center}
    		\includegraphics[
    		width=0.7\linewidth,
